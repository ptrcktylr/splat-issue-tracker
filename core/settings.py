...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'splat-issue-tracker.herokuapp.com',
    'splat-issue-tracker.onrender.com',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'group_tags' : 'authentication.templatetags.group_tags'
            }
        },
    },
]
...
# Use S3 for media storage if AWS credentials are provided
